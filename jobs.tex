...
\begin{itemize}
  ...
  \item We want balanced load of the resources
  \item Fair share according to time allocations
  \item Only persons/groups belonging to a time allocation can run \\~
  \item We use a queuing/batch system
...
\subsection{SLURM}
\frame{
\frametitle{SLURM queueing system}
...
\begin{itemize}
 ...
 \end{itemize}
 \item Job Prority computed based on 
 \begin{description}
