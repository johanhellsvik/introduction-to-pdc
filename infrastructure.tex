...
\scriptsize
  ...
  \begin{alertblock}{$5$ x $1$TB Fat nodes}
    4x 12 core Ivy Bridge, $1$TB RAM \\
    $2$ x Nvidia Quadro K420
  \end{alertblock}
  
  \begin{alertblock}{$65$ Thin Nodes}
...
\begin{table}
  ...
  Nodes & 2,060 & 74 x 24 Haswell/GPU\\
  &&$10$ x $48$ Ivy bridge\\\hline
  RAM (GB) & $64$ or $128$ & $74$ x $512$GB\\
  && $5$ x $1024$GB\\
  && $5$ x $2$TB\\\hline
  Allocations &&\\
